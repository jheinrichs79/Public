<#  
    The function Get-MailDomainInfo is a PowerShell function that retrieves information about a domain’s mail DNS records. 
...
function Get-MailDomainInfo {
    ...
    return $info 
}   #End of function Get-MailDomainInfo 
