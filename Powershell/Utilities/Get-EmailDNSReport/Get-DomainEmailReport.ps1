<#  
    The function Get-EmailDNSReport is a PowerShell function that retrieves information about a domain’s mail DNS records. 
...
function Get-EmailDNSReport {
    ...
    return $info 
}   #End of function Get-EmailDNSReport
